...
- **Integração API Pública**: Integração com a API do Metropolitan Museum of Art para exibir obras de arte

## Requisitos Implementados

✅ 2 páginas web (1 pública + 1 privada)  
✅ Conteúdo consumido a partir da API criada  
✅ Integração com API pública (Metropolitan Museum of Art)  
...
- **API Externa**: [Metropolitan Museum of Art API](https://metmuseum.github.io/)
